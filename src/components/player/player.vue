        ...
        <div class="bottom">
          ...
          <div class="operators">
            <div class="icon i-left">
              <i class="iconfont mode" @click="changeMode" v-html="iconMode"></i>
            </div>
            <div class="icon i-left">
              <i class="iconfont icon-prev" @click="prev">&#xec1c;</i>
            </div>
            <div class="icon i-center">
              <i class="iconfont" @click="togglePlaying" v-html="playIcon"></i>
            </div>
            ...
            <div class="icon i-right">
              <i
                ...
                v-html="getFavoriteIcon(currentSong)"
              ></i>
            </div>
          </div>
        </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click.stop="open">
        ...
        <div class="control" @click.stop="togglePlaying">
          <progress-circle :radius="radius" :percent="percent">
            ...
            <i class="iconfont" :class="playing ? 'fa-play': 'fa-stop'" v-html="miniIcon"></i>
          </progress-circle>
        </div>
...
import { getSong, getLyric } from "@/services/song";
